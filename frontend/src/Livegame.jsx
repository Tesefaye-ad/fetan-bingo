...
export default function LiveGame({ roomCode, cardIds, onExit, setBalance, telegramId }) {
  ...
  const lastNumberInfo = lastNumber ? getLetterInfo(lastNumber) : null;
  ...
  return (
    <div style={{
      ...
      {/* ═══ Top Info Bar: Game ID | Players | Bet | Derash | Called ═══ */}
      <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "4px", marginBottom: "8px" }}>
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "8px", padding: "6px 4px", textAlign: "center" }}>
          <div style={{ color: "#aaa", fontSize: "9px", marginBottom: "2px" }}>Game ID</div>
          <div style={{ color: "#f39c12", fontSize: "11px", fontWeight: "bold" }}>{roomCode}</div>
        </div>
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "8px", padding: "6px 4px", textAlign: "center" }}>
          <div style={{ color: "#aaa", fontSize: "9px", marginBottom: "2px" }}>Players</div>
          <div style={{ color: "#fff", fontSize: "12px", fontWeight: "bold" }}>{playerCount}</div>
        </div>
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "8px", padding: "6px 4px", textAlign: "center" }}>
          <div style={{ color: "#aaa", fontSize: "9px", marginBottom: "2px" }}>Bet</div>
          <div style={{ color: "#fff", fontSize: "12px", fontWeight: "bold" }}>{entryFee}</div>
        </div>
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "8px", padding: "6px 4px", textAlign: "center" }}>
          <div style={{ color: "#aaa", fontSize: "9px", marginBottom: "2px" }}>Derash</div>
          <div style={{ color: "#2ecc71", fontSize: "12px", fontWeight: "bold" }}>{prizePool}</div>
        </div>
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "8px", padding: "6px 4px", textAlign: "center" }}>
          <div style={{ color: "#aaa", fontSize: "9px", marginBottom: "2px" }}>Called</div>
          <div style={{ color: "#fff", fontSize: "12px", fontWeight: "bold" }}>{calledNumbers.length}</div>
        </div>
      </div>
      ...
      {/* ═══ Main Content: Left Card | Right Numbers ═══ */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px", flex: 1, marginBottom: "8px" }}>

        {/* ─── LEFT: Bingo Card (or Watching placeholder) ─── */}
        <div style={{ background: "#1a1a2e", border: "1px solid #2a2a40", borderRadius: "10px", padding: "6px", overflowY: "auto", minHeight: "340px" }}>
          {cards.length === 0 ? (
              ...
              {watching ? (
                <>
                  ...
                  <div style={{ color: "#aaa", fontSize: "11px", lineHeight: "1.7", marginBottom: "15px" }}>
                    የእርስዎ ካርቴላ የለም።<br />አዲስ ቁጥር እስኪጠራ ድረስ ይጠብቁ።
                  </div>
        ...
        {/* ─── RIGHT: Called Numbers + Current + Automatic + Watching ─── */}
        <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
          ...
          <div style={{
            ...
            {recentNumbers.length === 0 ? (
              <div style={{ color: "#666", fontSize: "10px", width: "100%", textAlign: "center", padding: "6px 0" }}>
                ቁጥሮች ሲጠሩ እዚህ ይታያሉ
              </div>
            ) : (
          ...
          <div style={{
            ...
            <div style={{ color: "#aaa", fontSize: "10px", marginBottom: "8px", letterSpacing: "1px" }}>CURRENT</div>
            {lastNumber && lastNumberInfo ? (
              <div style={{
                background: "#fff",
                color: lastNumberInfo.color,
              ...
              <div style={{ color: "#666", fontSize: "14px", padding: "22px 0" }}>በመጠበቅ ላይ...</div>
            )}
          </div>
          ...
          <div style={{
            ...
            {watching ? (
              <>
                <div style={{ color: "#fff", fontSize: "16px", fontWeight: "bold", textAlign: "center", marginBottom: "12px" }}>
                  Watching Only
                </div>
                <div style={{ color: "#aaa", fontSize: "12px", textAlign: "center", lineHeight: "1.8" }}>
                  የእርስዎ ካርቴላ<br />
                  ተጨምሯል:: አዲስ ቁጥር<br />
                  እስኪጠራ ድረስ<br />
                  ይጠብቁ::
              ...
              <div style={{ color: "#aaa", fontSize: "12px", textAlign: "center", lineHeight: "1.7" }}>
                🎯 ተጫዋቾች<br />እስኪገቡ ድረስ<br />በመጠበቅ ላይ...
              </div>
            ) : status === "active" ? (
              <div style={{ color: "#2ecc71", fontSize: "13px", textAlign: "center", lineHeight: "1.7" }}>
                🎯 ጨዋታው<br />በሂደት ላይ ነው
              </div>
            ) : status === "finished" ? (
              <div style={{ color: "#f39c12", fontSize: "13px", textAlign: "center", lineHeight: "1.7" }}>
                🏁 ጨዋታው<br />ተጠናቅቋል
              </div>
            ) : null}
          </div>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            background: watching || status !== "active"
      ...
      {gameOver && (
        <div style={{
          ...
          <h2 style={{ color: "#f39c12", margin: 0, fontSize: "36px", letterSpacing: "3px", fontWeight: "bold" }}>
            BINGO!
          </h2>
          ...
          {gameOver.winners && gameOver.winners.length > 0 ? (
            <>
              ...
              <div style={{
                ...
                <div style={{ color: "#f39c12", fontSize: "14px", fontWeight: "bold", marginBottom: "10px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "4px", marginBottom: "4px" }}>
                  {[
                    ...
                    <div key={h.l} style={{
                      background: h.c, color: "#fff", textAlign: "center",
                      fontWeight: "bold", fontSize: "14px", padding: "6px 0", borderRadius: "6px",
                    }}>{h.l}</div>
                  ))}
                </div>
              ...
              {gameOver.winners.length > 1 && (
                <div style={{ display: "flex", flexWrap: "wrap", gap: "6px", justifyContent: "center", maxWidth: "95%" }}>
                  {gameOver.winners.slice(1).map((w, i) => (
                    <div key={i} style={{
                      background: "#1a1a2e", border: "1px solid #f39c12",
          ...
          <button
            ...
            style={{
              ...
              padding: "12px 40px", fontWeight: "bold", cursor: "pointer",
              fontSize: "14px", marginTop: "8px", marginBottom: "20px",
            }}
          >
            Back to Lobby
          </button>

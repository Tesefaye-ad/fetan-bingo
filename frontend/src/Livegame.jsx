...
export default function LiveGame({ roomCode, cardIds, onExit, setBalance, telegramId }) {
  ...
  useEffect(() => {
    ...
    socket.on("number_called", ({ number, calledNumbers: cn }) => {
      ...
      setTimeout(() => setShowNumberAnim(false), 1500);
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ─── RIGHT: Called Numbers + Current + Toggle + Status ─── */}
            ...
            {lastInfo ? (
              <div
                style={{
                  ...
                  boxShadow: "0 0 20px rgba(243,156,18,0.5)",
                  transform: showNumberAnim ? "scale(1.15)" : "scale(1)",
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            fontWeight: "bold",
            cursor:
              watching || status !== "active" ? "not-allowed" : "pointer",
          }}
        >
          BINGO!
        </button>
